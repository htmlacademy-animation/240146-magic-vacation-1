...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const introTitleAnimation = new _accentTypography__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`,
      500,
      600,
      `active`,
      `transform`);

  const introDateAnimation = new _accentTypography__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`,
      500,
      800,
      `active`,
      `transform`);
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const rulesTitleAnimation = new _accentTypography__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`,
      500,
      `active`,
      `transform`);
